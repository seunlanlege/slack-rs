...
pub struct DndSetSnoozeErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl DndSetSnoozeErrorSchema {
    /// Schema for error response from dnd.setSnooze method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> DndSetSnoozeErrorSchema {
...
pub enum Error {
    #[serde(rename = "missing_duration")]
    MissingDuration,
    #[serde(rename = "snooze_failed")]
    SnoozeFailed,
