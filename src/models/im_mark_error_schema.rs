...
/// ImMarkErrorSchema : Schema for error response im.mark method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImMarkErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ImMarkErrorSchema {
    /// Schema for error response im.mark method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ImMarkErrorSchema {
        ImMarkErrorSchema {
            error,
            ok,
        }
