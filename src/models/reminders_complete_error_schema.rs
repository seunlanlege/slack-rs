...
pub struct RemindersCompleteErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl RemindersCompleteErrorSchema {
    /// Schema for error response from reminders.complete method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> RemindersCompleteErrorSchema {
...
pub enum Error {
    ...
    NotFound,
    #[serde(rename = "cannot_complete_recurring")]
    CannotCompleteRecurring,
    #[serde(rename = "cannot_complete_others")]
