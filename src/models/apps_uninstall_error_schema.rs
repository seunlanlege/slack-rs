...
/// AppsUninstallErrorSchema : Schema for error response from apps.uninstall method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppsUninstallErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl AppsUninstallErrorSchema {
    /// Schema for error response from apps.uninstall method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> AppsUninstallErrorSchema {
...
pub enum Error {
    ...
    InvalidClientId,
    #[serde(rename = "bad_client_secret")]
    BadClientSecret,
    #[serde(rename = "client_id_token_mismatch")]
