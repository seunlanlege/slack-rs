...
/// RemindersInfoErrorSchema : Schema for error response from reminders.info method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemindersInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl RemindersInfoErrorSchema {
    /// Schema for error response from reminders.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> RemindersInfoErrorSchema {
