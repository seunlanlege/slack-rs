...
/// MpimListErrorSchema : Schema for error response from mpim.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MpimListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MpimListErrorSchema {
    /// Schema for error response from mpim.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MpimListErrorSchema {
        MpimListErrorSchema {
            error,
            ok,
        }
