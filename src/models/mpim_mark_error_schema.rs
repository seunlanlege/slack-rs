...
/// MpimMarkErrorSchema : Schema for error response from mpim.mark method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MpimMarkErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MpimMarkErrorSchema {
    /// Schema for error response from mpim.mark method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MpimMarkErrorSchema {
        MpimMarkErrorSchema {
            error,
            ok,
        }
