...
/// ImHistoryErrorSchema : Schema for error response from im.history method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImHistoryErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ImHistoryErrorSchema {
    /// Schema for error response from im.history method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ImHistoryErrorSchema {
