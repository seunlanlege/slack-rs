...
pub struct FilesDeleteErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl FilesDeleteErrorSchema {
    /// Schema for error response files.delete method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> FilesDeleteErrorSchema {
