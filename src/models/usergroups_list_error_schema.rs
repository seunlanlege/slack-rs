...
/// UsergroupsListErrorSchema : Schema for error response from usergroups.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsergroupsListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsergroupsListErrorSchema {
    /// Schema for error response from usergroups.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsergroupsListErrorSchema {
