...
/// ChannelsSetTopicErrorSchema : Schema for error response from channels.setTopic method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsSetTopicErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsSetTopicErrorSchema {
    /// Schema for error response from channels.setTopic method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsSetTopicErrorSchema {
