...
pub struct ConversationsRepliesErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsRepliesErrorSchema {
    /// Schema for error response from conversations.replies method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsRepliesErrorSchema {
