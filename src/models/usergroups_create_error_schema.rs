...
/// UsergroupsCreateErrorSchema : Schema for error response from usergroups.create method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsergroupsCreateErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsergroupsCreateErrorSchema {
    /// Schema for error response from usergroups.create method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsergroupsCreateErrorSchema {
