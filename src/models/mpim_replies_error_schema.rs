...
/// MpimRepliesErrorSchema : Schema for error response from mpim.replies method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MpimRepliesErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MpimRepliesErrorSchema {
    /// Schema for error response from mpim.replies method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MpimRepliesErrorSchema {
