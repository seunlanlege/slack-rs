...
pub struct ChatDeleteScheduledMessageSchema {
    #[serde(rename = "ok")]
    pub ok: crate::models::DefsOkTrue,
}

impl ChatDeleteScheduledMessageSchema {
    /// Schema for successful response from chat.deleteScheduledMessage method
    pub fn new(ok: crate::models::DefsOkTrue) -> ChatDeleteScheduledMessageSchema {
