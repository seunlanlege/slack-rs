...
/// TeamAccessLogsErrorSchema : Schema for error response from team.accessLogs method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TeamAccessLogsErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl TeamAccessLogsErrorSchema {
    /// Schema for error response from team.accessLogs method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> TeamAccessLogsErrorSchema {
...
pub enum Error {
    ...
    PaidOnly,
    #[serde(rename = "over_pagination_limit")]
    OverPaginationLimit,
