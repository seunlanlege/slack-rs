...
/// MigrationExchangeErrorSchema : Schema for error response from migration.exchange method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MigrationExchangeErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MigrationExchangeErrorSchema {
    /// Schema for error response from migration.exchange method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MigrationExchangeErrorSchema {
...
pub enum Error {
    #[serde(rename = "not_enterprise_team")]
    NotEnterpriseTeam,
