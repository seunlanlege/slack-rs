...
/// FilesRevokePublicUrlErrorSchema : Schema for error response from files.revokePublicURL method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FilesRevokePublicUrlErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl FilesRevokePublicUrlErrorSchema {
    /// Schema for error response from files.revokePublicURL method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> FilesRevokePublicUrlErrorSchema {
