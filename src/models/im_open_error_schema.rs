...
/// ImOpenErrorSchema : Schema for error response from im.open method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImOpenErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ImOpenErrorSchema {
    /// Schema for error response from im.open method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ImOpenErrorSchema {
        ImOpenErrorSchema {
            error,
            ok,
        }
