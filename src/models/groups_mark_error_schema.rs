...
/// GroupsMarkErrorSchema : Schema for error response from groups.mark method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsMarkErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsMarkErrorSchema {
    /// Schema for error response from groups.mark method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsMarkErrorSchema {
