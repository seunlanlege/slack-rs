...
/// UsergroupsDisableErrorSchema : Schema for error response from usergroups.disable method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsergroupsDisableErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsergroupsDisableErrorSchema {
    /// Schema for error response from usergroups.disable method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsergroupsDisableErrorSchema {
