...
/// RemindersAddErrorSchema : Schema for error response from reminders.add method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemindersAddErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl RemindersAddErrorSchema {
    /// Schema for error response from reminders.add method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> RemindersAddErrorSchema {
...
pub enum Error {
    #[serde(rename = "cannot_parse")]
    CannotParse,
    #[serde(rename = "user_not_found")]
    UserNotFound,
    #[serde(rename = "cannot_add_bot")]
    CannotAddBot,
    #[serde(rename = "cannot_add_slackbot")]
    CannotAddSlackbot,
    #[serde(rename = "cannot_add_others")]
    CannotAddOthers,
    #[serde(rename = "cannot_add_others_recurring")]
