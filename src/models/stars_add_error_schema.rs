...
pub struct StarsAddErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl StarsAddErrorSchema {
    /// Schema for error response from stars.add method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> StarsAddErrorSchema {
        StarsAddErrorSchema {
            error,
            ok,
        }
