...
/// TeamInfoErrorSchema : Schema for error response from team.info method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TeamInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl TeamInfoErrorSchema {
    /// Schema for error response from team.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> TeamInfoErrorSchema {
        TeamInfoErrorSchema {
            error,
            ok,
        }
