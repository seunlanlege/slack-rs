...
/// DndInfoErrorSchema : Schema for error response from dnd.info method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DndInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl DndInfoErrorSchema {
    /// Schema for error response from dnd.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> DndInfoErrorSchema {
        DndInfoErrorSchema {
            error,
            ok,
        }
