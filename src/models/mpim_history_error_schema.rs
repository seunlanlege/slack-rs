...
/// MpimHistoryErrorSchema : Schema for error response from mpim.history method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MpimHistoryErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MpimHistoryErrorSchema {
    /// Schema for error response from mpim.history method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MpimHistoryErrorSchema {
