...
/// DndEndSnoozeErrorSchema : Schema for error response from dnd.endSnooze method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DndEndSnoozeErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl DndEndSnoozeErrorSchema {
    /// Schema for error response from dnd.endSnooze method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> DndEndSnoozeErrorSchema {
...
pub enum Error {
    #[serde(rename = "snooze_not_active")]
    SnoozeNotActive,
    #[serde(rename = "snooze_end_failed")]
    SnoozeEndFailed,
