...
pub struct AppsPermissionsRequestErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl AppsPermissionsRequestErrorSchema {
    /// Schema for error response from apps.permissions.request method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> AppsPermissionsRequestErrorSchema {
