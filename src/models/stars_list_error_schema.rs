...
/// StarsListErrorSchema : Schema for error response from stars.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StarsListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl StarsListErrorSchema {
    /// Schema for error response from stars.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> StarsListErrorSchema {
