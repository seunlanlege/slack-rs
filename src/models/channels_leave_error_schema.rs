...
/// ChannelsLeaveErrorSchema : Schema for error response from channels.leave method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsLeaveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsLeaveErrorSchema {
    /// Schema for error response from channels.leave method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsLeaveErrorSchema {
...
pub enum Error {
    ...
    IsArchived,
    #[serde(rename = "cant_leave_general")]
    CantLeaveGeneral,
    #[serde(rename = "cant_leave_mandatory_shared_channel")]
    CantLeaveMandatorySharedChannel,
