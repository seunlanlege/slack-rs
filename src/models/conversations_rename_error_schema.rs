...
/// ConversationsRenameErrorSchema : Schema for error response from conversations.rename method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConversationsRenameErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsRenameErrorSchema {
    /// Schema for error response from conversations.rename method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsRenameErrorSchema {
