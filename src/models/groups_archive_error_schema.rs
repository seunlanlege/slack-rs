...
/// GroupsArchiveErrorSchema : Schema for error response from groups.archive method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsArchiveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsArchiveErrorSchema {
    /// Schema for error response from groups.archive method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsArchiveErrorSchema {
...
pub enum Error {
    ...
    AlreadyArchived,
    #[serde(rename = "group_contains_others")]
    GroupContainsOthers,
