...
/// GroupsRepliesErrorSchema : Schema for error response from groups.replies method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsRepliesErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsRepliesErrorSchema {
    /// Schema for error response from groups.replies method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsRepliesErrorSchema {
