...
/// ConversationsLeaveErrorSchema : Schema for error response from conversations.leave method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConversationsLeaveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsLeaveErrorSchema {
    /// Schema for error response from conversations.leave method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsLeaveErrorSchema {
