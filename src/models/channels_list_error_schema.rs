...
/// ChannelsListErrorSchema : Schema for error response channels.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsListErrorSchema {
    /// Schema for error response channels.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsListErrorSchema {
