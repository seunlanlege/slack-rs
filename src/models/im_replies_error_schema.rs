...
/// ImRepliesErrorSchema : Schema for error response from im.replies method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImRepliesErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ImRepliesErrorSchema {
    /// Schema for error response from im.replies method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ImRepliesErrorSchema {
