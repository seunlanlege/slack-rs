...
pub struct BotsInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl BotsInfoErrorSchema {
    /// Schema for error response from bots.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> BotsInfoErrorSchema {
        BotsInfoErrorSchema {
            error,
            ok,
        }
