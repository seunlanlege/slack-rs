...
/// GroupsListErrorSchema : Schema for error response groups.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsListErrorSchema {
    /// Schema for error response groups.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsListErrorSchema {
