...
pub struct ConversationsSetPurposeErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsSetPurposeErrorSchema {
    /// Schema for error response from conversations.setPurpose method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsSetPurposeErrorSchema {
