...
pub struct UsergroupsUsersListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsergroupsUsersListErrorSchema {
    /// Schema for error response from usergroups.users.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsergroupsUsersListErrorSchema {
