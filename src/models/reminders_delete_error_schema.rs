...
/// RemindersDeleteErrorSchema : Schema for error response from reminders.delete method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemindersDeleteErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl RemindersDeleteErrorSchema {
    /// Schema for error response from reminders.delete method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> RemindersDeleteErrorSchema {
