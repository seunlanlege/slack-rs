...
/// ImListErrorSchema : Schema for error response from im.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ImListErrorSchema {
    /// Schema for error response from im.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ImListErrorSchema {
        ImListErrorSchema {
            error,
            ok,
        }
