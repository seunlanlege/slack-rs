...
pub struct ConversationsHistoryErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsHistoryErrorSchema {
    /// Schema for error response from conversations.history method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsHistoryErrorSchema {
