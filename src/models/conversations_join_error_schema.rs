...
pub struct ConversationsJoinErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsJoinErrorSchema {
    /// Schema for error response from conversations.join method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsJoinErrorSchema {
