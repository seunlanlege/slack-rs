...
/// TeamBillableInfoErrorSchema : Schema for error response from team.billableInfo method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TeamBillableInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl TeamBillableInfoErrorSchema {
    /// Schema for error response from team.billableInfo method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> TeamBillableInfoErrorSchema {
