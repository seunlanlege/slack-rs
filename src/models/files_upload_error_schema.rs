...
/// FilesUploadErrorSchema : Schema for error response files.upload method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FilesUploadErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl FilesUploadErrorSchema {
    /// Schema for error response files.upload method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> FilesUploadErrorSchema {
...
pub enum Error {
    #[serde(rename = "posting_to_general_channel_denied")]
    PostingToGeneralChannelDenied,
    #[serde(rename = "invalid_channel")]
    InvalidChannel,
    #[serde(rename = "file_uploads_disabled")]
    FileUploadsDisabled,
    #[serde(rename = "file_uploads_except_images_disabled")]
    FileUploadsExceptImagesDisabled,
    #[serde(rename = "storage_limit_reached")]
    StorageLimitReached,
