...
/// ChannelsMarkErrorSchema : Schema for error response channels.mark method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsMarkErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsMarkErrorSchema {
    /// Schema for error response channels.mark method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsMarkErrorSchema {
