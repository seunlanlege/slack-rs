...
/// FilesSharedPublicUrlErrorSchema : Schema for error response from files.sharedPublicURL method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FilesSharedPublicUrlErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl FilesSharedPublicUrlErrorSchema {
    /// Schema for error response from files.sharedPublicURL method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> FilesSharedPublicUrlErrorSchema {
