...
/// ChannelsUnarchiveErrorSchema : Schema for error response from channels.unarchive method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsUnarchiveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsUnarchiveErrorSchema {
    /// Schema for error response from channels.unarchive method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsUnarchiveErrorSchema {
