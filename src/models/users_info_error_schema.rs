...
/// UsersInfoErrorSchema : Schema for error response from users.info method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsersInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsersInfoErrorSchema {
    /// Schema for error response from users.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsersInfoErrorSchema {
