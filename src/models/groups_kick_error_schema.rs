...
/// GroupsKickErrorSchema : Schema for error response from groups.kick method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsKickErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsKickErrorSchema {
    /// Schema for error response from groups.kick method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsKickErrorSchema {
