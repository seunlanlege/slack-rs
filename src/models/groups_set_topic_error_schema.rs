...
/// GroupsSetTopicErrorSchema : Schema for error response from groups.setTopic method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsSetTopicErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsSetTopicErrorSchema {
    /// Schema for error response from groups.setTopic method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsSetTopicErrorSchema {
