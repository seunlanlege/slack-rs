...
pub struct ConversationsUnarchiveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsUnarchiveErrorSchema {
    /// Schema for error response from conversations.unarchive method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsUnarchiveErrorSchema {
