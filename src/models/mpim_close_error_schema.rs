...
/// MpimCloseErrorSchema : Schema for error response from mpim.close method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MpimCloseErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MpimCloseErrorSchema {
    /// Schema for error response from mpim.close method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MpimCloseErrorSchema {
