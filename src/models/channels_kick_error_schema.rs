...
/// ChannelsKickErrorSchema : Schema for error response from channels.kick method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsKickErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsKickErrorSchema {
    /// Schema for error response from channels.kick method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsKickErrorSchema {
