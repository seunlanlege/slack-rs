...
pub struct ChatUnfurlErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChatUnfurlErrorSchema {
    /// Schema for error response from chat.unfurl method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChatUnfurlErrorSchema {
...
pub enum Error {
    #[serde(rename = "cannot_unfurl_url")]
    CannotUnfurlUrl,
    #[serde(rename = "cannot_find_service")]
    CannotFindService,
    #[serde(rename = "missing_unfurls")]
    MissingUnfurls,
    #[serde(rename = "cannot_prompt")]
    CannotPrompt,
