...
pub struct ChatPostEphemeralErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChatPostEphemeralErrorSchema {
    /// Schema for error response from chat.postEphemeral method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChatPostEphemeralErrorSchema {
...
pub enum Error {
    ...
    TooManyAttachments,
    #[serde(rename = "user_not_in_channel")]
    UserNotInChannel,
