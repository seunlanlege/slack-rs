...
/// UsersListErrorSchema : Schema for error response from users.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsersListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsersListErrorSchema {
    /// Schema for error response from users.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsersListErrorSchema {
