...
/// AppsPermissionsInfoErrorSchema : Schema for error response from apps.permissions.info method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppsPermissionsInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl AppsPermissionsInfoErrorSchema {
    /// Schema for error response from apps.permissions.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> AppsPermissionsInfoErrorSchema {
