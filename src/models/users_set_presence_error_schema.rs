...
/// UsersSetPresenceErrorSchema : Schema for error response from users.setPresence method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsersSetPresenceErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsersSetPresenceErrorSchema {
    /// Schema for error response from users.setPresence method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsersSetPresenceErrorSchema {
