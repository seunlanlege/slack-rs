...
/// UsersDeletePhotoErrorSchema : Schema for error response from users.deletePhoto method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsersDeletePhotoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsersDeletePhotoErrorSchema {
    /// Schema for error response from users.deletePhoto method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsersDeletePhotoErrorSchema {
