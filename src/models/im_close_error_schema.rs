...
/// ImCloseErrorSchema : Schema for error response from im.close method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImCloseErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ImCloseErrorSchema {
    /// Schema for error response from im.close method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ImCloseErrorSchema {
        ImCloseErrorSchema {
            error,
            ok,
        }
