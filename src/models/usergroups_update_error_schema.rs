...
/// UsergroupsUpdateErrorSchema : Schema for error response from usergroups.update method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UsergroupsUpdateErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsergroupsUpdateErrorSchema {
    /// Schema for error response from usergroups.update method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsergroupsUpdateErrorSchema {
