...
pub struct AppsPermissionsInfoSchemaInfo {
    ...
    pub app_home: crate::models::AppsPermissionsInfoSchemaInfoAppHome,
    #[serde(rename = "channel")]
    pub channel: crate::models::AppsPermissionsInfoSchemaInfoAppHome,
    #[serde(rename = "group")]
    pub group: crate::models::AppsPermissionsInfoSchemaInfoAppHome,
    #[serde(rename = "im")]
    pub im: crate::models::AppsPermissionsInfoSchemaInfoAppHome,
    #[serde(rename = "mpim")]
    pub mpim: crate::models::AppsPermissionsInfoSchemaInfoAppHome,
    #[serde(rename = "team")]
    pub team: crate::models::AppsPermissionsInfoSchemaInfoTeam,
}
