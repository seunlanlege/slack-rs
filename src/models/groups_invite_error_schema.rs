...
/// GroupsInviteErrorSchema : Schema for error response groups.invite method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsInviteErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsInviteErrorSchema {
    /// Schema for error response groups.invite method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsInviteErrorSchema {
