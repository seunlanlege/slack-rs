...
/// GroupsSetPurposeErrorSchema : Schema for error response from groups.setPurpose method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsSetPurposeErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsSetPurposeErrorSchema {
    /// Schema for error response from groups.setPurpose method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsSetPurposeErrorSchema {
