...
pub struct FilesInfoErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl FilesInfoErrorSchema {
    /// Schema for error response from files.info method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> FilesInfoErrorSchema {
...
pub enum Error {
    ...
    FileDeleted,
    #[serde(rename = "timezone_count_failed")]
    TimezoneCountFailed,
