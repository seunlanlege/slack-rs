...
/// GroupsCreateChildErrorSchema : Schema for error response from groups.createChild method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsCreateChildErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsCreateChildErrorSchema {
    /// Schema for error response from groups.createChild method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsCreateChildErrorSchema {
