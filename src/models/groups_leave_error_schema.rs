...
/// GroupsLeaveErrorSchema : Schema for error response from groups.leave method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsLeaveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsLeaveErrorSchema {
    /// Schema for error response from groups.leave method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsLeaveErrorSchema {
