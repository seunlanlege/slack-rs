...
impl ConversationsMembersSuccessSchema {
    ...
    pub fn new(members: Vec<String>, ok: crate::models::DefsOkTrue, response_metadata: crate::models::ChatScheduledMessagesListSchemaResponseMetadata) -> ConversationsMembersSuccessSchema {
