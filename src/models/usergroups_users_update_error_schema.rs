...
pub struct UsergroupsUsersUpdateErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsergroupsUsersUpdateErrorSchema {
    /// Schema for error response from usergroups.users.update method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsergroupsUsersUpdateErrorSchema {
