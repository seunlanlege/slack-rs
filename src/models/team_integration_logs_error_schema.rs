...
pub struct TeamIntegrationLogsErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl TeamIntegrationLogsErrorSchema {
    /// Schema for error response from team.integrationLogs method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> TeamIntegrationLogsErrorSchema {
