...
/// GroupsUnarchiveErrorSchema : Schema for error response from groups.unarchive method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsUnarchiveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsUnarchiveErrorSchema {
    /// Schema for error response from groups.unarchive method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsUnarchiveErrorSchema {
