...
pub struct ConversationsMembersErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ConversationsMembersErrorSchema {
    /// Schema for error response conversations.members method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsMembersErrorSchema {
...
pub enum Error {
    ...
    InvalidCursor,
    #[serde(rename = "fetch_members_failed")]
    FetchMembersFailed,
