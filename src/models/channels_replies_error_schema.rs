...
/// ChannelsRepliesErrorSchema : Schema for error response from channels.replies method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsRepliesErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsRepliesErrorSchema {
    /// Schema for error response from channels.replies method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsRepliesErrorSchema {
