...
pub struct AppsPermissionsResourcesListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl AppsPermissionsResourcesListErrorSchema {
    /// Schema for error response from apps.permissions.resources.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> AppsPermissionsResourcesListErrorSchema {
