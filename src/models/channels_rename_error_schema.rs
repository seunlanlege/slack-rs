...
/// ChannelsRenameErrorSchema : Schema for error response from channels.rename method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsRenameErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsRenameErrorSchema {
    /// Schema for error response from channels.rename method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsRenameErrorSchema {
