...
/// ConversationsListErrorSchema : Schema for error response from conversations.list method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConversationsListErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
...
impl ConversationsListErrorSchema {
    /// Schema for error response from conversations.list method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsListErrorSchema {
