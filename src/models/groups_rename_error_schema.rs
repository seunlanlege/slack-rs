...
/// GroupsRenameErrorSchema : Schema for error response from groups.rename method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsRenameErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsRenameErrorSchema {
    /// Schema for error response from groups.rename method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsRenameErrorSchema {
