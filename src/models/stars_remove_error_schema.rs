...
pub struct StarsRemoveErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl StarsRemoveErrorSchema {
    /// Schema for error response from stars.remove method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> StarsRemoveErrorSchema {
