...
pub struct UsersProfileSetErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl UsersProfileSetErrorSchema {
    /// Schema for error response from users.profile.set method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> UsersProfileSetErrorSchema {
...
pub enum Error {
    ...
    InvalidProfile,
    #[serde(rename = "profile_set_failed")]
    ProfileSetFailed,
    #[serde(rename = "not_admin")]
    NotAdmin,
    #[serde(rename = "not_app_admin")]
    NotAppAdmin,
    #[serde(rename = "cannot_update_admin_user")]
