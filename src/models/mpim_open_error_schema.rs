...
/// MpimOpenErrorSchema : Schema for error response from mpim.open method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MpimOpenErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl MpimOpenErrorSchema {
    /// Schema for error response from mpim.open method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> MpimOpenErrorSchema {
        MpimOpenErrorSchema {
            error,
            ok,
        }
