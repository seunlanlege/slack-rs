...
/// GroupsOpenErrorSchema : Schema for error response from groups.open method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupsOpenErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl GroupsOpenErrorSchema {
    /// Schema for error response from groups.open method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> GroupsOpenErrorSchema {
