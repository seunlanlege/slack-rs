...
impl ObjsUserProfileShort {
    pub fn new(avatar_hash: String, display_name: String, first_name: String, image_72: String, is_restricted: bool, is_ultra_restricted: bool, name: String, real_name: String, team: String) -> ObjsUserProfileShort {
