...
/// RtmConnectErrorSchema : Schema for error response from rtm.connect method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RtmConnectErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl RtmConnectErrorSchema {
    /// Schema for error response from rtm.connect method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> RtmConnectErrorSchema {
