...
/// ChannelsJoinErrorSchema : Schema for error response from channels.join method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChannelsJoinErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ChannelsJoinErrorSchema {
    /// Schema for error response from channels.join method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ChannelsJoinErrorSchema {
