...
pub struct ConversationsArchiveSuccessSchema {
    #[serde(rename = "ok")]
    pub ok: crate::models::DefsOkTrue,
}

impl ConversationsArchiveSuccessSchema {
    /// Schema for successful response conversations.archive method
    pub fn new(ok: crate::models::DefsOkTrue) -> ConversationsArchiveSuccessSchema {
