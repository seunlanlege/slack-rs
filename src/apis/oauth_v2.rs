...
pub async fn v2_access(configuration: &configuration::Configuration, params: V2AccessParams) -> Result<AuthPayload, Error<V2AccessError>> {
    ...
    let data: Option<AuthPayload> = serde_json::from_str(&content).ok();
